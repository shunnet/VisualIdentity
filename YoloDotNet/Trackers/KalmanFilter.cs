...
{
    /// <summary>Tracks two-dimensional position and velocity with a Kalman filter.</summary>
    /// <param name="x">The initial horizontal center coordinate.</param>
    /// <param name="y">The initial vertical center coordinate.</param>
