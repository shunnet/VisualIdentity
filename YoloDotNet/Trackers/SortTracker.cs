...
{
    /// <summary>Associates detections across frames using prediction and optimal assignment.</summary>
    public partial class SortTracker
    {
        ...
        /// <summary>Initializes a SORT tracker.</summary>
        /// <param name="costThreshold">Maximum assignment cost accepted as a match.</param>
        /// <param name="maxAge">Maximum unmatched frames before a track is removed.</param>
        /// <param name="tailLength">Maximum number of historical points retained per track.</param>
