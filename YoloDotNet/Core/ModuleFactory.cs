...
namespace YoloDotNet.Core
{
    ...
    internal class ModuleFactory
    {
        ...
        new()
        {
            ...
            },
            {
                ModelVersion.V26, new Dictionary<ModelType, Func<YoloCore, IModule>>
                {
                    ...
                    { ModelType.SemanticSegmentation, core => new SemanticSegmentationModuleV26(core) },
                    { ModelType.DepthEstimation, core => new DepthEstimationModuleV26(core) }
                }
            },
            {
                ModelVersion.V26E, new Dictionary<ModelType, Func<YoloCore, IModule>>
                {
                    { ModelType.Classification, core => throw new NotImplementedException() },
                    { ModelType.ObjectDetection, core => new ObjectDetectionModuleV26(core) },
                    { ModelType.ObbDetection, core => throw new NotImplementedException() },
                    { ModelType.Segmentation, core => new SegmentationModuleV26(core) },
                    { ModelType.PoseEstimation, core => throw new NotImplementedException() },
                    { ModelType.SemanticSegmentation, core => throw new NotImplementedException() },
                    { ModelType.DepthEstimation, core => throw new NotImplementedException() }
                }
            },
            {
        ...
        public static IModule CreateModule(YoloOptions options)
        {
            ...
            if (!_versionModuleMap.TryGetValue(modelVersion, out var moduleMap) ||
                !moduleMap.TryGetValue(modelType, out var createModule))
            {
                yoloCore.Dispose();
            ...
            catch (NotImplementedException ex)
            {
                yoloCore.Dispose();
                options.ExecutionProvider.Dispose();
                throw new YoloDotNetModelException($"Unsupported detection type {modelType} for model version {modelVersion}.", ex);
            }
            catch
            {
                yoloCore.Dispose();
