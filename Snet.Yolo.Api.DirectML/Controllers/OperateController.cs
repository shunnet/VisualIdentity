...
namespace Snet.Yolo.Api.Controllers
{
    ...
    public class OperateController : OperateBaseController
    {
        ...
        /// <inheritdoc/>
        public override string Tag => "DirectML";
        ...
        /// </returns>
        [HttpPost]
        public Task<OperateResult> IdentityAsync(int onnxIndex, [AllowedFileType(new[] { ".jpg", ".jpeg", ".png", ".bmp" })] IFormFile file, string paramJson, int gpuid = 0)
            => IdentityCoreAsync(onnxIndex, file, paramJson, path => new DirectMLExecutionProvider(path, gpuid));
        ...
        /// </returns>
        [HttpPost]
        public Task<OperateResult> IdentityDrawAsync(int onnxIndex, [AllowedFileType(new[] { ".jpg", ".jpeg", ".png", ".bmp" })] IFormFile file, string paramJson, int gpuid = 0)
            => IdentityDrawCoreAsync(onnxIndex, file, paramJson, path => new DirectMLExecutionProvider(path, gpuid));
    }
}
